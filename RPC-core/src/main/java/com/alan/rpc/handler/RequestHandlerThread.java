...
public class RequestHandlerThread implements Runnable{
    ...
    private ServiceProvider serviceRegister;

    public RequestHandlerThread(Socket socket, RequestHandler requestHandler, ServiceProvider serviceRegister) {
        this.socket = socket;
    ...
    public void run() {
        ...
        try(ObjectInputStream ois = new ObjectInputStream(socket.getInputStream());
            ...
            Object service = serviceRegister.getServiceProvider(interfaceName);
            //服务处理
